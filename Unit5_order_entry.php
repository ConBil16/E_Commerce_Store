...
<html>
    <head>
        ...
        <script type = "text/javascript" src="Unit5_script.js"></script>
    </head>
...
<body>
    ...
    function myFunction(str) {
            if (str == "") {
                ...
                xmlhttp.open("GET","Unit5_get_quantity.php?q="+str,true);
                xmlhttp.send();
                }
        }
    ...
    xmlhttp.open("GET", "Unit5_get_customer_table.php?q=" + hint + "&h=" + type, true);
    xmlhttp.send();
    }
}
